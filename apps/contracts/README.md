# farcaster-miniapp - Smart Contracts

This directory contains the smart contracts for farcaster-miniapp, built with Hardhat and optimized for the Celo blockchain.
